...
public class AdminController {
	...
	public String adminPage(Model model) {
		...
		listCongViec.setSoDonHangMoi(donHangService.countByTrangThaiDonHang("Waiting for delivery"));
		listCongViec.setSoDonhangChoDuyet(donHangService.countByTrangThaiDonHang("Waiting for approval"));
		listCongViec.setSoLienHeMoi(lienHeService.countByTrangThai("Waiting for reply"));
	...
	public String quanLyDonHangPage(Model model) {
		...
		for (NguoiDung shipper : shippers) {
			shipper.setListDonHang(donHangService.findByTrangThaiDonHangAndShipper("Delivering", shipper));
		}
