        ...
        <h2 class="form-signin-heading">Register an account</h2>
            ...
            <div class="form-group">
                <form:input type="text" path="hoTen" class="form-control"
                            placeholder="First and last name" required="required"></form:input>
...
<head>
<meta charset="UTF-8">
<title>Laptop Shop - Register</title>
	...
	<div class="login-page">
		<div class="form">
			<form:form method="POST" action='register' modelAttribute="newUser">
				...
				<p class="message" style="font-size: 18; padding-top:10px"> You already have an account? <a href="<c:url value='/login'/> ">login</a></p>
			</form:form>
		</div>
	</div>
	<script
