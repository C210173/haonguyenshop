			...
			<%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
				...
				<body>
					...
					<div class="col-md-9 animated bounce">
						<h3 class="page-header form-inline">Order Management</h3>
						...
						<form class="form-inline" id="searchForm" name="searchObject">
							...
							&nbsp;&nbsp; &nbsp;&nbsp;
							<button type="button" class="btn btn-primary" id="btnDuyetDonHang">order browsing</button>
							<div class="form-group" style="float: right; margin-right: 20px">
								<input class="form-control" type="number" id="searchById"
									placeholder="Enter the code to find it quickly"> <span
					...
					<div class="row col-md-6">
						<form class="phanCongForm" id="form">
							<div>
								<div class="modal fade" id="phanCongModal" tabindex="-1" role="dialog"
									aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static"
									data-keyboard="false">
									<div class="modal-dialog" role="document">
										<div class="modal-content">
											<div class="modal-header">
												<h5 class="modal-title" id="exampleModalLabel">Order assignment</h5>
											...
											<div class="modal-body">
												...
												<div class="form-group">
													Choose a shipper for the order:<select class="form-control"
														name="shipper">
					...
					<div class="row col-md-6">
						<form class="capNhatTrangThaiForm" id="form">
							<div>
								<div class="modal fade" id="capNhatTrangThaiModal" tabindex="-1" role="dialog"
									aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static"
									data-keyboard="false">
									<div class="modal-dialog " role="document">
										<div class="modal-content">
											<div class="modal-header">
												<h5 class="modal-title" id="exampleModalLabel">Order completion
													confirmation
												</h5>
												<button type="button" class="close" data-dismiss="modal"
													aria-label="Close">
												...
												<div class="form-group">
													<div class="col-md-12">
														...
														<h4 id="tongTienXacNhan"
															style="float: right; font-weight: bold;padding-right: 50px">
															abc</h4>
													</div>

													<div>
														<h5 id="ghiChu" style="font-weight: bold; padding-top: 10px">
															Note </h5>
