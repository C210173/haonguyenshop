		...
		<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
			...
			<body>
				...
				<div class="col-md-9 animated bounce">
					<h3 class="page-header">Contact Management</h3>
					<div class="form-group form-inline">
						...
						&nbsp;&nbsp; &nbsp;&nbsp;
						<button type="button" class="btn btn-primary" id="btnDuyetLienHe">Browse Contacts</button>
					</div>
					<hr>
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<div class="form-group">
												<label for="name">Contact content:</label>
												<textarea class="form-control" name="noiDungLienHe" id="ndLienHe"
													style="border: 0; background-color: #fff" rows="3"
													readonly="readonly"></textarea>
											</div>
											<div class="form-group">
												<label for="noiDungTraLoi">Reply content</label>
												<textarea class="form-control" name="noiDungTraLoi" id="ndTraLoi"
													rows="5"></textarea>
